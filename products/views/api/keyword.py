...
import products.services.keyword as keyword_service
...
class KeywordAPIView(APIView):
    ...
    async def get(self, request):
        data = await sync_to_async(keyword_service.get_all)()
    ...
    async def post(self, request):
        data = await sync_to_async(keyword_service.create)(request.data)
...
class KeywordDetailAPIView(APIView):
    ...
    async def get(self, request, pk):
        data = await sync_to_async(keyword_service.get)(pk)
    ...
    async def patch(self, request, pk):
        data = await sync_to_async(keyword_service.update)(pk, request.data)
        return Response(data, status=status.HTTP_200_OK)
    ...
    async def delete(self, request, pk):
        await sync_to_async(keyword_service.delete)(pk)
